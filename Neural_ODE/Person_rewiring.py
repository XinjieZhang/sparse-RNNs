...
import sys
sys.path.append('../')
from Neural_ODE.network import Model
    ...
    for epoch in range(hp['training_iters']):
        ...
        with tf.Session() as sess:
            ...
            if hp['rewiring_algorithm'] == 'DeepR':
                ...
                noise_update = lambda th: np.random.normal(scale=1e-4, size=th.shape)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--modeldir', type=str, default='../results/Person_node/deep_rewiring_n_64_p_0.05')
